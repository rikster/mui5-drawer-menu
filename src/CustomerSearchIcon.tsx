...
export const CustomerSearchIcon = (props: SvgIconProps) => {
	return (
		<SvgIcon {...props}>
			<title>CustomerSearch_icon</title>
			<g id="CustomerSearch_icon" stroke="none" strokeWidth="1">
				<g
					id="1-Icons-/-action-/customer-search"
